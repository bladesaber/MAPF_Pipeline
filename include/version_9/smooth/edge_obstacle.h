...
*/
    ...
    public:
        ...
        EdgeXYZ_Obstacle(Eigen::Vector3d obstacle, double min_obstacle_dist, double kSpring):
                obstacle(obstacle), min_obstacle_dist(min_obstacle_dist), kSpring(kSpring) {
            this->setMeasurement(0.0);
        }
        ...
        void computeError() {
            ...
            _error[0] = penaltyBoundFromBelow(dist, min_obstacle_dist) * kSpring;
