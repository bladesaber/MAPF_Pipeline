...
public:
    ...
    AgentInfo(){};
    AgentInfo(
        size_ut agentIdx, size_ut groupIdx, double radius,
        std::tuple<int, int, int> startPos,
        std::tuple<int, int, int> endPos
    ):agentIdx(agentIdx), groupIdx(groupIdx), radius(radius), startPos(startPos), endPos(endPos){};
    ...
    void info(){
        std::cout << "AgentIdx: " << agentIdx << " GroupIdx: " << groupIdx << std::endl;
...
public:
    ...
    void addAgent(
        ...
        AgentInfo* agent = new AgentInfo(agentIdx, groupIdx, radius, startPos, endPos);
