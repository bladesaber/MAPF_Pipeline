...
from scripts_py.version_6.env_cfg import pipe_config, obstacle_config, env_config
...
def main():
    ### Just For Debug
    # create_mesh('/home/quan/Desktop/MAPF_Pipeline/scripts_py/version_6/app_dir/mesh')

    ### -------------------------------------------
    json_file = '/home/quan/Desktop/MAPF_Pipeline/scripts_py/version_6/app_dir/env_cfg.json'
    ...
    #     env_cfg=env_config, save_dir='/home/quan/Desktop/MAPF_Pipeline/scripts_py/version_6/app_dir'
    # )

    # env_config = create_GridEnv(env_config, save_dir='/home/quan/Desktop/MAPF_Pipeline/scripts_py/version_6/app_dir')

    with open(grid_json_file, 'r') as f:
        env_config = json.load(f)

    env_config = create_Grid_WallObstacle(env_cfg=env_config, save_dir='/home/quan/Desktop/MAPF_Pipeline/scripts_py/version_6/app_dir')
