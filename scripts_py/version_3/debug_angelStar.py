...
#     isConflict = constraint_table.isConstrained(instance, cur, next, 0.5)
#     print('isConstrained: ', isOnlight)
...
isConflict = constraint_table.isConstrained(instance, path[0], path[1], 0.5)
print('isConflict: ', isConflict)

islineOnSight = constraint_table.islineOnSight(instance, path[0], path[1], 0.5)
print('islineOnSight: ', islineOnSight)