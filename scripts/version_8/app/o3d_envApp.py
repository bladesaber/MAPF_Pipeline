...
class ObstacleUtils(object):
    ...
    @staticmethod
    def create_PipeShell(xyz, radius, direction, reso):
    ...
    @staticmethod
    def removePointInShell(xyzs, shellRange):
...
class CustomApp(AppWindow):
    ...
    def refitEnv(self):
        ...
        for name in pipeNames:
            ...
            shell_xyzs, shell_range = ObstacleUtils.create_PipeShell(
        ...
        for name in self.geoMap.keys():
            ...
            if geoInfo['shape'] != 'shell':
                ...
                for shell_name in shell_filters.keys():
                    ...
                    xyzs = ObstacleUtils.removePointInShell(xyzs, shellRange)
