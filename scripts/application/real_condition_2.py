...
# o3d.io.write_triangle_mesh('/home/quan/Desktop/MAPF_Pipeline/scripts/application/replace.STL', obs_mesh)
...
# np.save(
#     '/home/quan/Desktop/MAPF_Pipeline/scripts/application/real_condition2_map', 
#     agentsInfo
# )

# ### ------ make obstacle pcd
# mesh = o3d.io.read_triangle_mesh('/home/quan/Desktop/MAPF_Pipeline/scripts/application/replace.STL')
...
#     '/home/quan/Desktop/MAPF_Pipeline/scripts/application/obs.csv'
# )

### ------ visulaize simulation run condition
# agentsInfo = np.load(
#     '/home/quan/Desktop/MAPF_Pipeline/scripts/application/real_condition2_map.npy', allow_pickle=True
# ).item()

# pcd_df = pd.read_csv('/home/quan/Desktop/MAPF_Pipeline/scripts/application/obs.csv', index_col=0)
...
cond_params = {
    ...
    'save_dir': '/home/quan/Desktop/MAPF_Pipeline/scripts/application',
...
agentInfos = np.load(
    '/home/quan/Desktop/MAPF_Pipeline/scripts/application/real_condition2_map.npy', 
    allow_pickle=True
).item()
