...
double point2LineSegmentDistance(
    ...
    double norm0 = norm2_distance(lineStart_x, lineStart_y, lineStart_z, point_x, point_y, point_z);
    double norm1 = norm2_distance(lineEnd_x, lineEnd_y, lineEnd_z, point_x, point_y, point_z);
    ...
    double line_length = norm2_distance(endX, endY, endZ, startX, startY, startZ);
